...
#toc-page(outline-depth: 3)

#show: main-content

= 基本功能 <intro>

请注意，你正在使用 #sys.version 版本的 Typst，请留意可能的差异。本文仅对 Typst 的基本功能进行了简要介绍，更多详细信息请参考#link("https://typst.app/docs/")[官方文档]（英文）或#link("https://typst-doc-cn.github.io/guide/")[中文社区提供的导航]（强烈推荐）。写作可以使用#link("https://typst.app/")[网页版 Web App]，或本地安装#link("https://code.visualstudio.com/download")[VS Code]和#link("https://github.com/Myriad-Dreamin/tinymist")[Tinymist 插件]。当然，如果你偏好任何其他支持 LSP 的编辑器，也可以使用 Tinymist。
...
除了这一简略方式，也可以通过 `heading` 函数自定义标题的更多属性。具体可以参考#link("https://typst.app/docs/reference/model/heading/")[文档中的有关内容]。
...
本模板目录的默认最大深度为 3，即只有前三级标题会出现在目录中。如果需要更深的目录，可以更改 `outline-depth` 设置。
...
暂时没有提供表格的具体样式设置，用户可以自由使用合适的表格，参考官方文档#footnote([https://typst.app/docs/reference/model/table/])
...
/*
当前一篇文章仅能有一处 bibliography, 放在最后了
#bibliography(
  "ref.bib",
  title: none,
  style: "ieee"
